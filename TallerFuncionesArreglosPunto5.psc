SubProceso vectorResultado ( resultado Por Referencia )
...
//Punto 5, taller de arreglos usando funciones, ejercicios de la tabla de multiplicar del 1 al 10.
Proceso TallerFuncionesArreglosPunto5
	Definir fila, columna, resultado Como Entero;
	Definir texto_filas, control Como Caracter;
	Dimension resultado[10,10];
	
	control <- "Y";
	vectorResultado(resultado);	
