//Punto 10 condicionales usando funciones, aplicación para llevar las cuentas de los usuarios del banco "Su banco fiel"
SubProceso opc <- Menu ( t )
	Definir opc Como Entero;
	Escribir "Bienvenido, ", t, " elija una opción:";
...
SubProceso nuevaCantidad <- IngresarCantidad ( c, t )
	Definir nuevaCantidad Como Entero;
	nuevaCantidad <- c + t;
FinSubProceso

SubProceso nuevaCantidad <- RetirarCantidad ( c, t )
	Definir nuevaCantidad Como Entero;
	nuevaCantidad <- c - t;
FinSubProceso

Proceso TallerFuncionesCondicionalesPunto10
		...
		Segun opcion Hacer
			...
			2:
				...
				Si titular = titular1 Entonces
					...
					SiNo
						cantidad1 <- RetirarCantidad(cantidad1,transaccion);
				...
				SiNo
					Si titular = titular2 Entonces
						...
						SiNo
							cantidad2 <- RetirarCantidad(cantidad2,transaccion);
					...
					SiNo
						...
						SiNo
							cantidad3 <- RetirarCantidad(cantidad3,transaccion);
